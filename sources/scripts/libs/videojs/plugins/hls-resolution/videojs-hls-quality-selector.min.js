...
(function (global, factory) {
    ...
    class HlsQualitySelectorPlugin {
      ...
      createQualityButton() {
        ...
        const placementIndex = player.controlBar.children().length - 1;
    ...
    const hlsQualitySelector = function (options) {
      this.ready(() => {
        ...
        onPlayerReady(this, videojs__default['default'].obj? videojs__default['default'].obj.merge(defaults, options) : {});
